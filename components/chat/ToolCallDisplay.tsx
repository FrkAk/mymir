  ...
  return (
    <div className={className}>
      <button
        ...
        className="cursor-pointer rounded-md border border-border bg-surface-raised px-2 py-1 font-mono text-xs text-text-muted transition-colors hover:bg-surface-hover"
      >
