/**
 * AI SDK tool definitions for the Trellis web app.
  ...
  return {
    ...
    signalBrainstormComplete: tool({
      description:
        ...
        "Call this ONLY after you have explored all 6 topics and named the project via trellis_project. " +
...
export function decomposeTools(projectId: string) {
  return {
    trellis_task: tool({
      description: DESCRIPTIONS.trellis_task,
      inputSchema: z.object({
    ...
    trellis_edge: tool({
      description: DESCRIPTIONS.trellis_edge,
      inputSchema: z.object({
    ...
    trellis_query: tool({
      description: DESCRIPTIONS.trellis_query,
      inputSchema: z.object({
    ...
    trellis_context: tool({
      description: DESCRIPTIONS.trellis_context,
      inputSchema: z.object({
...
/**
 * Build tools for the refine scope. trellis_task is hardwired to the selected task.
...
export function refineScopedTools(taskId: string, projectId: string) {
  return {
    ...
    trellis_analyze: tool({
      description: DESCRIPTIONS.trellis_analyze,
      inputSchema: z.object({
...
export function allTools(projectId: string) {
  return {
    trellis_project: tool({
      description: DESCRIPTIONS.trellis_project,
      inputSchema: z.object({
