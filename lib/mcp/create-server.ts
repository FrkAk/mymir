...
const INSTRUCTIONS = [
  "Trellis is a persistent context network for coding projects.",
  ...
  "The `select` action on trellis_project is not supported in remote mode.",
].join("\n");

/**
 * Create a stateless MCP server with all 6 Trellis tools registered.
