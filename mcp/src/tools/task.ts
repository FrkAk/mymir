...
/**
 * Register the trellis_task tool on the MCP server.
    ...
    "trellis_task",
    {
      ...
      inputSchema: z.object({
        ...
        category: z.string().optional()
          .describe("Drawer group for this task. Should match a project category. Run trellis_project to see available categories."),
